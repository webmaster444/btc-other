function topChart() {
    ...
    function csrender(selection) {
        selection.each(function() {
            ...
            var valuelineema12 = d3.svg.line().x(function(d) {return x(d.Date);}).y(function(d) {return botTmpY(d['ema']);});
            var valuelineema26 = d3.svg.line().x(function(d) {return x(d.Date);}).y(function(d) {return botTmpY(d['ema']);});
...
if(period=='1w'){
    ...
    .call(xAxis.orient("bottom").ticks(8));  
            ...
            var rect = d3.select(".bot_g").append("svg:rect")
                ...
                .on("mouseover", function() { 
                    bot_focus_g.style("display", null); bot_x_move_wrapper.style("display",null);
                    focus_g.style("display", null); x_move_wrapper.style("display",null);
                    bot_x_line.style('display',null);bot_y_line.style('display',null)
                    x_line.style('display',null);y_line.style('display',null)
                })
                .on("mouseout", function() { 
                    bot_focus_g.style("display", "none"); bot_x_move_wrapper.style("display","none");
                    focus_g.style("display", "none"); x_move_wrapper.style("display","none");
                    bot_x_line.style('display','none');bot_y_line.style('display','none')
                    x_line.style('display','none');y_line.style('display','none')
                })
                .on("mousemove", mousemove)
                .call(zoom).on("wheel.zoom", null);
